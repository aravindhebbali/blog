...
description: "Practical Introduction to Market Basket Analysis"
date: '2019-05-02'
...
```{r meme, fig.align='center', out.width="60%", echo=FALSE}
knitr::include_graphics("J:/R/blog_research/mba/img/mba_meme.jpg")
```
...
We have created a tiny R package 
<a href="" target="_blank">mbar</a>,  for data pre-processing. It can be 
installed from GitHub as shown below:
...
Other than mbar, we will be using the following packages:
...
```{r pre_process, fig.align='center', out.width="100%", echo=FALSE}
knitr::include_graphics("J:/R/blog_research/mba/img/mba_pre_process.png")
```

As shown above, the data set has one row per item. We will use 
`mbar_prep_data()` from the mbar package to reshape the data so that there is 
one row per transaction with items across columns exclusing the column names. 
...
you find a way to get it to work.
...
Finally, what you have been waiting for. Let us generate some rules. The 
...
```{r lift_warning, fig.align='center', out.width="100%", echo=FALSE}
knitr::include_graphics("J:/R/blog_research/mba/img/mba_lift_warning_final.png")
```
...
```{r conf_warning, fig.align='center', out.width="100%", echo=FALSE}
knitr::include_graphics("J:/R/blog_research/mba/img/mba_conf_warn_final.png")
```

## Summary

```{r summary_meme, fig.align='center', out.width="60%", echo=FALSE}
knitr::include_graphics("J:/R/blog_research/mba/img/mba_summary_meme.jpg")
```
