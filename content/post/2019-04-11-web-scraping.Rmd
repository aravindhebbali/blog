...
<a href="https://www.rsquaredacademy.com/" target="_blank"><img src="/img/ad.png" width="80%" alt="course ad" style="text-decoration: none;"></a>
...
<p>
<a href="https://www.youtube.com/user/rsquaredin/" target="_blank"><img src="/img/ad_youtube.png" width="80%" alt="youtube ad" style="text-decoration: none;"></a>
</p>
...
knitr::include_graphics("/img/blog_ws_cs_top_mobiles_border.png")
```
...
knitr::include_graphics("/img/blog_ws_mobile_brand_name_border.png")
```
...
`a` as it is a HTML tag. Both the class and the tag are specified within quotes 
...
- use `str_split()` from **stringr** and specify the pattern `\\(` i.e split 
the string @ the first opening bracket. Since `(` is a special character, we 
use `\\` for escaping. 
- next, we use `map_chr()` from the **purrr** package to extract the first 
...
knitr::include_graphics("/img/blog_ws_mobile_color_border.png")
```
...
knitr::include_graphics("/img/blog_ws_mobile_rating_border.png")
```
...
knitr::include_graphics("/img/blog_ws_mobile_reviews_border.png")
```
...
knitr::include_graphics("/img/blog_ws_real_price_border.png")
```
...
knitr::include_graphics("/img/blog_ws_actual_price_border.png")
```
...
Let use convert the price to a number using the same steps as in the
case of real price.
...
<a href="https://apps.rsquaredacademy.com/" target="_blank"><img src="/img/ad_apps.png" width="80%" alt="apps ad" style="text-decoration: none;"></a>
...
<a href="https://pkgs.rsquaredacademy.com/" target="_blank"><img src="/img/ad_packages.png" width="80%" alt="packages ad" style="text-decoration: none;"></a>
...
knitr::include_graphics("/img/blog_ws_cs_top_websites_border.png")
```
...
Let us check if we can scrape the data from the IMDB website using 
